  ...
  return (
    ...
    >
      ...
      <div className="p-3.5 bg-gradient-to-b from-gg-gray-700 to-gg-gray-800 text-white">
        ...
        {companyName && (
          <div className="text-xs text-gg-gray-300 flex items-center gap-1 mt-1.5">
            <Building2 size={11} />
            {companyName}
          </div>
        )}
...
export default function PortalWatchlistPanel({ listings, loading, onClose, onRemoveListing, onSelectListing }: PortalWatchlistPanelProps) {
  return (
    <motion.div
      ...
      className="fixed top-0 left-0 bottom-0 w-[440px] z-[510] bg-black border-r border-white/10 shadow-2xl flex flex-col"
    >
      {/* Header */}
