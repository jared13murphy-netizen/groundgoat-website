      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-8 text-gg-gray-300">
          ...
          <section>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us at: <a href="mailto:no-reply@groundgoat.com" className="text-gg-pink hover:underline">no-reply@groundgoat.com</a></p>
            <div className="mt-4">
