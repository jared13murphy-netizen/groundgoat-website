...
export default function ListingDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-gg-black">
      {/* Hero Image */}
      <div className="relative h-72 md:h-96 bg-gg-gray-900">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-gg-black via-transparent to-gg-black/50" />
        ...
        {listing.status !== 'listed' && (
          <div className={`absolute bottom-6 left-6 px-4 py-2 rounded-full text-sm font-semibold text-white ${getStatusColor(listing.status)}`}>
            {getStatusLabel(listing.status)}
          </div>
        )}
      </div>

      <div className="max-w-5xl mx-auto px-6 -mt-12 relative z-10 pb-12">
        {/* Main Info Card */}
